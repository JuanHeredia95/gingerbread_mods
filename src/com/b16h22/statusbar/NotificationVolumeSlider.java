	...
	private BroadcastReceiver mRingerInfoReceiver; 
	 public NotificationVolumeSlider(final Context context, AttributeSet attrs) {
		  super(context, attrs);
		    ...
		    map.put("img", R.drawable.ic_volume_notif);
		    ...
		    boolean value = sharedPreferences.getBoolean("isChecked3", false);
            if (value) {   
		    ...
		    check.setChecked(sharedPreferences.getBoolean("isChecked3", false));
		    check.setOnCheckedChangeListener(new OnCheckedChangeListener() {
		            ...
		            if (isChecked3) {   
			            ...
			            editor.putBoolean("isChecked3", true); //true or false
			            editor.commit();
		            }
		            else {
		            	volControl.setEnabled(true);
			            SharedPreferences sharedPreferences = context.getSharedPreferences(my_pref, Context.MODE_PRIVATE);
			            SharedPreferences.Editor editor = sharedPreferences.edit(); //opens the editor
			            editor.putBoolean("isChecked3", false); //true or false
			            editor.commit();
		            }
		            }   
		        });
