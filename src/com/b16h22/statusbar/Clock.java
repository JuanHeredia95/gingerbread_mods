	 ...
	 public Clock(final Context context, AttributeSet attrs) {
		  super(context, attrs);
	        ...
	        clock.setVisibility(0);
              ...
              context.registerReceiver(mclockcolorReceiver, new IntentFilter("com.b16h22.statusbar.CHANGE_CLOCK_COLOR"));
              context.registerReceiver(mclockHideReceiver, new IntentFilter("com.b16h22.statusbar.HIDE_CLOCK"));
              context.registerReceiver(mclockUnhideReceiver, new IntentFilter("com.b16h22.statusbar.UNHIDE_CLOCK"));
	 }
